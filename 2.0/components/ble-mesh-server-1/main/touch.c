...
static void touch_read_fcn(uint8_t pad)
{
    ...
    case TOUCH_PAD_NUM7:
        ...
        snprintf(my_msg, sizeof(my_msg), "Killer queen is at strike again, my little boy:%d", num++);
        ble_mesh_send_vendor_message((uint16_t)0x0001 ,my_msg, strlen(my_msg));
        break;
    ...
    case TOUCH_PAD_NUM9:
        ...
        snprintf(my_msg2, sizeof(my_msg2), "I'm your final hope 005, my dear friend:%d", num2++);
